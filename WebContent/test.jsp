...
$('#myButton').click(function(){
    ...
    //$.ajax({  contentType: "application/xml; charset=utf-8", type: "POST", url: "http://localhost:8080/onyxWS/rest/service/pdo", data: { xml : incomingXML}, success: function(msg) {  alert(msg); }, });
    $.ajax({  contentType: "application/xml; charset=utf-8", type: "POST", url: "http://localhost:8080/onyxWS/rest/service/pdo", data: {incomingXML: xmlContent, activity_id: "117"}, success: function(msg) {  alert(msg); }, });
